...
## Кластеры (по состоянию на 2026-05-17)
...
| К5 | Внимательная работа с опросниками | broshennye-oprosnye-listy, vremya-otveta-na-zayavku-b2b, adaptivnyy-oprosnyy-list, ai-podgotovka-k-zvonku-po-oprosniku (запущен 2026-05-17, источник тезисов — пиллары главной) |

> К4 пересекается с К2/К3 — статьи могут одновременно работать на два кластера. Главный кластер для каждой статьи — в её frontmatter (поле `cluster`). К5 — отдельный кластер, разворачивает 4 пиллара главной в 4 SEO-статьи 1:1.
...
На 2026-05-17: 21 статья, 13 + 4 пиллара К5 (полные) соответствуют CONTENT_STANDARDS, 2 «внешние» без frontmatter (допустимо). Таблица «Что починить» — в `content-plan.md`.
